...
def load_data():
    ...
    # Basic cleaning
    df['NOMBRE LOCALIDAD'] = df['NOMBRE LOCALIDAD'].str.strip()
    return df
...
try:
    ...
    all_localidades = sorted(df['NOMBRE LOCALIDAD'].unique())
